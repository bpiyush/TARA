...
from tarsier2.utils import _pad_input, _unpad_input
...
class Tarsier2PreTrainedModel(PreTrainedModel):
...
class Tarsier2ForConditionalGeneration(Tarsier2PreTrainedModel, GenerationMixin):
    def __init__(self, config: LlavaConfig):
