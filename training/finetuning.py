...
def train(
    ...
    # BaseModelForTARA is the base model wrapper in this repo (equivalent to
    # CaReBench's `AutoBase` dispatch for the Tarsier2 architecture). Training
    # only needs the model/tokenizer/processor, not the TARA encoder methods.
